        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex justify-between items-start">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
                <div>
                  {/* <div className="font-semibold text-[#3A1A1A] font-montserrat">Order ID: #{odooLead.id}</div> */}
                  ...
                  {/* <div className="font-semibold text-[#3A1A1A] font-montserrat">#{odooLead.id}</div> */}
                </div>
                
                <div>
                  {/* <div className="text-[#6B4B41] font-nunito">Phone</div>
                  <div className="font-semibold text-[#3A1A1A] font-montserrat">{odooLead.phone}</div> */}
                  <span className="text-[#6B4B41] font-nunito"> Phone: </span>
                  <span className="font-semibold text-[#3A1A1A] font-montserrat">{odooLead.phone} </span>
                </div>
              </div>
          </div>
        </div>
